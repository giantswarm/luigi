...
func Test_format(t *testing.T) {
	...
	for i, tt := range testCases {
		out := format([]byte(tt.In))
		if out != tt.ExpectedOut {
			t.Errorf("test %d:\n%q\nwant:\n%q", i, out, tt.ExpectedOut)
		}
	}
}
