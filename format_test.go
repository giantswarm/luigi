...
func Test_format(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expectedOut: `E 18-02-27 06:40:42 /apis/provider.giantswarm.io/v1alpha1/namespaces/default/awsconfigs/3cnwh loadbalancerv5.GetCurrentState stop framework reconciliation due to error | operatorkit/framework/framework.go:174 | event=update
	...
	status code: 400, request id: 2184a219-1b89-11e8-a0c2-21a5ccc5b186`,
		...
		},
		{
			...
			grep: make(map[string]string),
			expectedOut: `E 18-02-27 14:26:24 /apis/provider.giantswarm.io/v1alpha1/namespaces/default/awsconfigs/unoo8 UpdateFunc stop framework reconciliation due to error | operatorkit/framework/framework.go:174 | event=update
	...
	execution failed`,
		...
		},
		{
			...
			expectedOut: `W 18-06-01T06:26:15.261267+0 /apis/core.giantswarm.io/v1alpha1/namespaces/default/kvmclusterconfigs/h0cg9-kvm-cluster-config chartv2.GetCurrentState retrying due to error | operatorkit/controller/resource/retryresource/crud_resource_ops_wrapper.go:71 | event=update
	...
	Tiller installation failed`,
		...
		{
			name: "case 3: as case 2, but grep for level==error that yields grepNotFoundError",
			text: `{"caller":"github.com/giantswarm/cluster-operator/vendor/github.com/giantswarm/operatorkit/controller/resource/retryresource/crud_resource_ops_wrapper.go:71","event":"update","function":"GetCurrentState","level":"warning","message":"retrying due to error","object":"/apis/core.giantswarm.io/v1alpha1/namespaces/default/kvmclusterconfigs/h0cg9-kvm-cluster-config","resource":"chartv2","stack":"[{/go/src/github.com/giantswarm/cluster-operator/vendor/github.com/giantswarm/operatorkit/controller/resource/retryresource/crud_resource_ops_wrapper.go:64: } {/go/src/github.com/giantswarm/cluster-operator/pkg/v2/resource/chart/current.go:37: } {/go/src/github.com/giantswarm/cluster-operator/pkg/v2/resource/chart/resource.go:126: } {/go/src/github.com/giantswarm/cluster-operator/vendor/github.com/giantswarm/helmclient/helmclient.go:236: rpc error: code = Unimplemented desc = unknown service grpc.health.v1.Health} {Tiller installation failed}]","time":"2018-06-01T06:26:15.261267+00:00","resource":"chartv2"}`,
			grep: map[string]string{
				"level": "error",
			},
	...
	Tiller installation failed`,
		...
		{
			name: "case 5: as case 4 but grep for level==warning && function==GetCurrentState && non-existing-key==not_found yielding grepNotFoundError",
			text: `{"caller":"github.com/giantswarm/cluster-operator/vendor/github.com/giantswarm/operatorkit/controller/resource/retryresource/crud_resource_ops_wrapper.go:71","event":"update","function":"GetCurrentState","level":"warning","message":"retrying due to error","object":"/apis/core.giantswarm.io/v1alpha1/namespaces/default/kvmclusterconfigs/h0cg9-kvm-cluster-config","resource":"chartv2","stack":"[{/go/src/github.com/giantswarm/cluster-operator/vendor/github.com/giantswarm/operatorkit/controller/resource/retryresource/crud_resource_ops_wrapper.go:64: } {/go/src/github.com/giantswarm/cluster-operator/pkg/v2/resource/chart/current.go:37: } {/go/src/github.com/giantswarm/cluster-operator/pkg/v2/resource/chart/resource.go:126: } {/go/src/github.com/giantswarm/cluster-operator/vendor/github.com/giantswarm/helmclient/helmclient.go:236: rpc error: code = Unimplemented desc = unknown service grpc.health.v1.Health} {Tiller installation failed}]","time":"2018-06-01T06:26:15.261267+00:00","resource":"chartv2"}`,
			grep: map[string]string{
				"level":            "warning",
				"function":         "GetCurrentState",
				"non-existing-key": "not_found",
			},
			expectedOut:  "",
			errorMatcher: IsGrepNotFound,
		},
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			out, err := format([]byte(tc.text), tc.grep)
