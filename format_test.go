...
func Test_format(t *testing.T) {
	testCases := []struct {
		...
		{
			name:               "case 4: deal with numbers values",
		...
		{
			name:               "case 5: deal with null values",
			inputFile:          "null.in",
